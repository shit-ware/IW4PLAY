...
void FS_BuildOSPathForThreadHookTest()
{
	...
	{
		if (strcmp(writeFolder, "iw4play") != 0)
		{
			if (iw4m_onelog->current.boolean)
			{
				strcpy_s(writeFolder, 256, "iw4play");
			}
		}
	}
}
...
void PatchMW2_Redirect()
{
	...
	iw4m_onelog = (dvar_t*)Dvar_RegisterBool("iw4m_onelog", false, DVAR_FLAG_LATCHED || DVAR_FLAG_SAVED, "Only write the game log to the 'iw4play' OS folder");
}