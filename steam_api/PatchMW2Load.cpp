...
void __cdecl FFLoadHook2(XZoneInfo* data, int count, int unknown) {
	...
	memcpy(&newData[0], data, sizeof(XZoneInfo) * count);
	newData[count].name = "weap_iw4play"; // patch_alter_mp
	...
	newData[count].type2 = 0;
	count++;
	newData[count].name = "team_us_army";
	newData[count].type1 = 0;
	newData[count].type2 = 0;
	count++;
	newData[count].name = "team_opforce_airborne";
	newData[count].type1 = 0;
	newData[count].type2 = 0;
	count++;
	newData[count].name = "team_opforce_composite";
	newData[count].type1 = 0;
	newData[count].type2 = 0;
