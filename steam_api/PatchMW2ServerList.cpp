...
void CL_GlobalServers_f(void) {
	...
	NET_StringToAdr("iw4play.net", &to);
	cls.numglobalservers = -1;
	cls.pingUpdateSource = 0;
	to.type = NA_IP;
	to.port = htons(48521);//48521
...
//newMapArena_t* _arenas = *(newMapArena_t**)0x62E6934;//crash
//newMapArena_t* _arenas = *(newMapArena_t**)0x420717;
//mapArena_t* _arenas = (mapArena_t*)0x420717;
char* UI_LocalizeMapName(char* mapName)
{
	newMapArena_t* _arenas = *(newMapArena_t**)0x420717; //alle maps richtig zu sehen,nur nuketown bleibt leer
	//newMapArena_t* _arenas = *(newMapArena_t**)0x62E6934;
	//mapArena_t* _arenas = (mapArena_t*)0x420717;
	//mapArena_t* _arenas = (mapArena_t*)0x62E6934;
