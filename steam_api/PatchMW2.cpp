...
void PatchMW2_159()
{
	...
	*(BYTE*)0x45114C = 0xEB;
	...
	// master server
	strcpy((char*)0x6D9CBC, "iw4play.net");
	...
	*(const char**)0x51F5A6 = "Could not load image '%s'. If this image name starts with 'preview_mp_', you might be missing iw_22.iwd/iw_23.iwd. Read the relevant FAQ entry on http://iw4play.net";
...
void CL_OpenForums_f()
{
	ShellExecute(NULL, "open", "http://iw4play.net/forum/", 0, 0, SW_SHOWNORMAL);
}
...
void PatchMW2_Client()
{
	...
	*(BYTE*)0x5A1D43 = 0xEB;
	...
	static cmd_function_t openForumsCmd;
	Cmd_AddCommand("openForums", CL_OpenForums_f, &openForumsCmd, 0);
}
